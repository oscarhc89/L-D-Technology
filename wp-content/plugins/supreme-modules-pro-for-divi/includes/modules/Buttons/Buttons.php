...
class DSM_Button extends ET_Builder_Module {
	...
	function render( $attrs, $content = null, $render_slug ) {
		...
		if ( '' !== $button_one_text ) {
			...
			$button_output .= sprintf(
				'<a class="et_pb_button et_pb_button_one%5$s%8$s%9$s%10$s%12$s %7$s %14$s" %6$s href="%1$s"%3$s%4$s data-dsm-lightbox-id="dsm_button_one_lightbox %11$s "%13$s>%2$s</a>',
				$link_one_url,
				et_core_esc_previously( $button_one_text ),
		...
		if ( '' !== $button_two_text ) {
			...
			$button_output .= sprintf(
				'<a class="et_pb_button et_pb_button_two%5$s%8$s%9$s%10$s%12$s %7$s %14$s" %6$s href="%1$s"%3$s%4$s data-dsm-lightbox-id="dsm_button_two_lightbox %11$s"%13$s>%2$s</a>',
				$link_two_url,
				et_core_esc_previously( $button_two_text ),
