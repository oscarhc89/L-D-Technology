...
class DSM_Image_Hotspots_Child extends ET_Builder_Module {
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$icon_selector                     = '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspots_icon, .et-db #et-boc .et-l .dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .et-pb-icon.dsm_image_hotspots_icon';
		$pulse_selector                    = '.dsm_image_hotspots %%order_class%%.dsm_image_hotspots_child .dsm_image_hotspot_pulse:before';
