...
class DSM_CardCarousel_Child extends ET_Builder_Module {
		...
		return array(
			...
			'borders'         => array(
				'default' => array(
					'css' => array(
						'main' => array(
							'border_radii'  => ".dsm_card_carousel {$this->main_css_element}>div:first-of-type",
							'border_styles' => ".dsm_card_carousel {$this->main_css_element}>div:first-of-type",
						),
					),
				),
				'image'   => array(
			...
			'box_shadow'      => array(
				'default' => array(
					'css' => array(
						'main' => ".dsm_card_carousel {$this->main_css_element}>div:first-of-type",
					),
				),
				'image'   => array(
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$image = $image ? sprintf(
			...
			'on' !== $image_as_background ? $image : '<div class="dsm_card_carousel_child_image_background"></div>',
