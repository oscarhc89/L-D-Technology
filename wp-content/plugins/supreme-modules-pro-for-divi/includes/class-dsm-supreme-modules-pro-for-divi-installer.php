	...
	public function display_notice() {
		...
		echo sprintf(
			...
			'<p>' . sprintf(
				...
				wp_nonce_url( self_admin_url( 'update.php?action=install-plugin&plugin=' . $dsm_supreme_modules_lite_plugin_slug ), 'install-plugin_' . $dsm_supreme_modules_lite_plugin_slug )
			) . '</p>'
		);
	}
}
