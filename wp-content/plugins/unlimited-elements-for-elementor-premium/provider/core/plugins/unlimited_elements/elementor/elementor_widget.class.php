...
class UniteCreatorElementorWidget extends Widget_Base {
    ...
    private function sortParamsByCats($arrCats, $params){
    	...
    	$arrCats = UniteFunctionsUC::arrayToAssoc($arrCats, "id");
    	...
    	foreach($params as $param){
    		...
    		if(array_key_exists($catID, $arrCats) == false)
    			$catID = "cat_general_general";
    		...
    		if(array_key_exists($catID, $arrOutput) == false){
    			...
    			$cat = UniteFunctionsUC::getVal($arrCats, $catID);
    			
    			$catTitle = UniteFunctionsUC::getVal($cat, "title");
    			$catTab = UniteFunctionsUC::getVal($cat, "tab");
