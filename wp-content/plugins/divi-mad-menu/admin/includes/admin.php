...
/**
 * Enqueue Theme Builder JS and CSS.
 * 
 * @since v1.0.0
 * 
 */
if ( ! function_exists( 'dvmm_madmenu_tb_admin_enqueue_scripts' ) ) {
    function dvmm_madmenu_tb_admin_enqueue_scripts($hook) {
        // don't enqueue if it is not the Theme Builder page
        if ( 'divi_page_et_theme_builder' != $hook && 'extra_page_et_theme_builder' != $hook ) {
            return;
        }
    ...
    <div id="wrapper">
        <div id="panel-wrap">
            <form method="post" action="options.php" id="main_options_form" enctype="multipart/form-data">
                ...
                ?>
                <div id="dvmm-panel-wrapper">
                    <div id="dvmm-panel" class="">
                        <div id="dvmm-panel-content-wrap">
                            <div id="dvmm-panel-content">
                                ...
                                <div id="dvmm-updates" class="dvmm_tab_content dvmm_updates">
                                     ...
                                     */
                                    // do_action('dvmm_madmenu_render_update_option');
                                    dvmm_madmenu_license_activation_template();

                                    ?>
                                </div>
                            </div> <!-- end dvmm-panel-content div -->
                        </div> <!-- end dvmm-panel-content-wrap div -->
                    </div> <!-- end dvmm-panel div -->
                </div> <!-- end dvmm-panel-wrapper div -->
