...
class DVMM_Horizontal_Menu {
        ...
        $fields = array(
			'menu_breakpoint' => array(
				...
				'description'     => sprintf( 
					...
					esc_html__( 'Apply a different breakpoint for the desktop menu. The desktop menu will be visible on the screens having a width greater than the value set here.<br />(The breakpoint feature has only partial VB support due to the way the viewport resizing is handled by the builder)', 'dvmm-divi-mad-menu' )
				),
				'type'              => 'range',
	 ...
	 */
	static function menu_markup( $module, $args = array(), $get_the_menu ){
	 ...
	 * 
     */
	static function menus( $module, $processed_props = array(), $get_the_menu ){

		// print_r($processed_props);
