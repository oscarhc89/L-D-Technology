	...
	public function get_fields( $module ) {
        $fields = array(
			'dvmm_enable_menu' => array(
				...
				'affects'		=> $module->helpers()->dvmm_enable_menu__affects('menu'),
				'default'       => 'on',
				'tab_slug'      => 'general',
        ...
        $advanced_fields = array(
			'fonts'      => array(
				...
				'dvmm_mobile_menu' => array(
					...
					'css'             => array(
						'main'         	=> "{$dvmm_mobile_menu} li a",
						'limited_main' 	=> "{$dvmm_mobile_menu} li a",
						'hover'        	=> "{$dvmm_mobile_menu} li:hover > a",
						'font_size'		=> "{$dvmm_mobile_menu} li a",
						'text_align'	=> "{$dvmm_mobile_menu} li a",
					),
					'line_height'     => array(
						'default' => '2em',
					),
				...
				'dvmm_mobile_menu_f' => array(
					...
					'css'             => array(
						'main'         	=> "{$dvmm_mobile_menu__fixed} li a",
						'limited_main' 	=> "{$dvmm_mobile_menu__fixed} li a",
						'hover'        	=> "{$dvmm_mobile_menu__fixed} li:hover > a",
						'font_size'		=> "{$dvmm_mobile_menu__fixed} li a",
						'text_align'	=> "{$dvmm_mobile_menu__fixed} li a",
					),
					'line_height'     => array(
						'default' => '2em',
					),
				...
				'dvmm_button_one' => array(
					...
					'css'             => array(
						'main'         	=> "{$module->main_css_element} .dvmm_button_one",
						// 'limited_main' 	=> "{$module->main_css_element} .dvmm_button_one",
						'hover'        	=> "{$module->main_css_element} .dvmm_button_one:hover",
						'font_size'		=> "{$module->main_css_element} .dvmm_button_one",
				...
				'dvmm_button_one_f' => array(
					...
					'css'             => array(
						'main'         	=> "{$module->main_css_element} .dvmm_fixed .dvmm_button_one",
						// 'limited_main' 	=> "{$module->main_css_element} .dvmm_fixed .dvmm_button_one",
						'hover'        	=> "{$module->main_css_element} .dvmm_fixed .dvmm_button_one:hover",
						'font_size'		=> "{$module->main_css_element} .dvmm_fixed .dvmm_button_one",
				...
				'dvmm_button_two' => array(
					...
					'css'             => array(
						'main'         	=> "{$module->main_css_element} .dvmm_button_two",
						// 'limited_main' 	=> "{$module->main_css_element} .dvmm_button_two",
						'hover'        	=> "{$module->main_css_element} .dvmm_button_two:hover",
						'font_size'		=> "{$module->main_css_element} .dvmm_button_two",
				...
				'dvmm_button_two_f' => array(
					...
					'css'             => array(
						'main'         	=> "{$module->main_css_element} .dvmm_fixed .dvmm_button_two",
						// 'limited_main' 	=> "{$module->main_css_element} .dvmm_fixed .dvmm_button_two",
						'hover'        	=> "{$module->main_css_element} .dvmm_fixed .dvmm_button_two:hover",
						'font_size'		=> "{$module->main_css_element} .dvmm_fixed .dvmm_button_two",
